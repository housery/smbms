...
<div class="right">
        ...
        <div class="providerAdd">
           <form id="providerForm" name="providerForm" method="post"
                 action="${pageContext.request.contextPath }/sys/provider/addprovidersave.html"
               ...
               <div>
                   ...
                   <%--a_companyLicPicPath不要起companyLicPicPath这样会映射到pojo的属性，controller层会出现参数绑定异常--%>
                   <input type="file" name="a_companyLicPicPath" id="companyLicPicPath">
                   <font color="red"></font>
               </div>
